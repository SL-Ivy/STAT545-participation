...
![](cm014-exercise_files/figure-html/unnamed-chunk-12-1.png)<!-- -->![](cm014-exercise_files/figure-html/unnamed-chunk-12-2.png)<!-- -->![](cm014-exercise_files/figure-html/unnamed-chunk-12-3.png)<!-- -->![](cm014-exercise_files/figure-html/unnamed-chunk-12-4.png)<!-- -->
...
ggplot(gapminder, aes(gdpPercap, lifeExp)) +
    geom_point() +
    geom_smooth(method="lm", se = F) + #se=F hide the 95% confidence interval
    scale_x_log10()
```
...
__Although it can be seen from the plot that it's not linear, we can do the modification/transformation to the model.
...
```r
ggplot(gapminder_Zimbabwe, aes(year, lifeExp)) + geom_point()+geom_smooth(method = "lm", formula = y ~ poly(I(x -1952), degree =2)) # in the formula, we must use x and y, instead of "year" and "lifeExp"
```

![](cm014-exercise_files/figure-html/unnamed-chunk-16-1.png)<!-- -->
